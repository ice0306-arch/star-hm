...
export const universityTierSnapshots: UniversityTierSnapshot[] = [
  { college: "수술대", total: 23, race: race(5, 9, 9), tiers: { God: 1, King: 1, Jack: 1, Joker: 3, "0": 1, "1": 1, "3": 3, "4": 1, "5": 2, "6": 3, "7": 3, "8": 1, Baby: 2 }, memberNames: ["정중만", "짭제", "신상문", "선우도현", "이소룡", "다린", "공다츠", "파찌", "기나", "몽순", "깨림이", "밍가", "핑핑", "2라니", "면추가", "아링", "밥새", "혜요이", "봉덕이", "온도이", "전제민", "윤준석", "김기덕"], memberMarkers: [{ name: "정중만", label: "이사장" }] },
  ...
  { college: "무소속", total: 105, race: race(25, 36, 44), tiers: { God: 14, King: 5, Jack: 8, Joker: 11, Spade: 14, "0": 6, "1": 5, "2": 2, "3": 4, "4": 8, "5": 7, "6": 8, "7": 6, "8": 5, Baby: 2 } },
  { college: "캄몬스타즈", total: 22, race: race(6, 10, 6), tiers: { God: 2, King: 2, Jack: 5, "2": 1, "3": 2, "4": 2, "5": 3, "6": 2, "7": 2, Baby: 1 }, memberNames: ["김윤환", "변현제", "김민철", "박준오", "사테", "지동원", "배성흠", "박수범", "남덕선", "토마토", "지두두", "햇살", "찌킹", "치리", "주하랑", "소주양", "임조이", "비타밍", "먼진", "아리송이", "낭니", "왜냐맨"], memberMarkers: [{ name: "김윤환", label: "총장" }] },
  ...
  { college: "신세계", total: 14, race: race(3, 4, 7), tiers: { God: 1, King: 1, Jack: 1, Joker: 2, "2": 1, "4": 1, "5": 1, "6": 1, "7": 2, "8": 2, Baby: 1 }, memberNames: ["설영욱", "몽군", "윤수철", "권혁진", "킁식", "김상곤", "또봉순", "연애인", "예실", "김설", "요시", "지우리", "혜냥", "밤하밍"], memberMarkers: [{ name: "설영욱", label: "이사장" }, { name: "몽군", label: "총장" }] },
];
