...
export const universityTierSnapshots: UniversityTierSnapshot[] = [
  { college: "수술대", total: 20, race: race(5, 8, 7), tiers: { God: 1, King: 1, Jack: 1, "0": 1, "1": 1, "3": 3, "4": 1, "5": 2, "6": 3, "7": 3, "8": 1, Baby: 2 }, memberNames: ["정중만", "짭제", "신상문", "선우도현", "이소룡", "다린", "공다츠", "파찌", "기나", "몽순", "깨림이", "밍가", "핑핑", "2라니", "면추가", "아링", "밥새", "혜요이", "봉덕이", "온도이"], memberMarkers: [{ name: "정중만", label: "이사장" }] },
  ...
  { college: "뉴캣슬", total: 23, race: race(5, 6, 12), tiers: { God: 2, Jack: 1, Joker: 3, Spade: 3, "3": 1, "4": 2, "5": 1, "6": 2, "7": 3, "8": 4, Baby: 1 }, memberNames: ["기뉴다", "도재욱", "액션구드론", "초난강", "키링", "최도랑", "퀸주", "막내현진", "단솔", "은니", "박성균", "구라미스", "김건욱", "트슈", "박성준", "박두두", "백갑숙", "진유성", "이아경", "냥냥코기", "밍또암", "유즈", "하윤"], memberMarkers: [{ name: "기뉴다", label: "대장" }, { name: "도재욱", label: "총장" }] },
  ...
  { college: "HM", total: 14, race: race(3, 3, 8), tiers: { God: 1, King: 1, Joker: 1, Spade: 1, "0": 1, "1": 1, "3": 1, "4": 1, "5": 1, "6": 1, "7": 1, "8": 1, Baby: 1, Unknown: 1 }, memberNames: ["혁민", "강민", "최호선", "방태수", "박준혁", "파메", "솔아", "이응씨", "카리스", "연블비", "이아라", "사랑e", "세월", "설둥이"], memberMarkers: [{ name: "혁민", label: "이사장" }, { name: "강민", label: "총장" }, { name: "연블비", label: "학생회장" }], featured: true },
  ...
  { college: "신세계", total: 14, race: race(3, 4, 7), tiers: { God: 1, King: 1, Jack: 1, Joker: 2, "2": 1, "4": 1, "5": 1, "6": 1, "7": 2, "8": 2, Unknown: 1 }, memberNames: ["설영욱", "몽군", "윤수철", "권혁진", "킁식", "김상곤", "또봉순", "연애인", "예슬", "김설", "요시", "지우리", "혜냥", "밤하밍"], memberMarkers: [{ name: "설영욱", label: "이사장" }, { name: "몽군", label: "총장" }] },
];
